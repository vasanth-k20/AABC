...
export default function PaperSubmission() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://icaabc.com/papsubmi.php', {
                method: 'POST',
                body: formDataToSend,
            });
    ...
    <div className="w-full xl:w-[65%] px-4 flex flex-col lg:flex-row gap-8 items-center justify-center mx-auto">
        ...
        <div className="w-full lg:w-2/3 bg-white shadow-lg rounded-2xl p-8 border-t-4 border-b-4 border-green-500 order-2 lg:order-1">
